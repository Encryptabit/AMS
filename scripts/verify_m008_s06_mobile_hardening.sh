...
add_check "persistence-seams" "FullyQualifiedName~WorkstationMobileHardeningContractTests|FullyQualifiedName~ProofCrxBatchExportContractTests|FullyQualifiedName~CrxChapterMatcherTests"
