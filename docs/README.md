...
Working model for the Core cleanup:

- The feature slice catalogue defines the refactor targets and owns the line/file ledger.
- The northstar defines the philosophy and cross-slice review standard.
- The slice docs define the concrete changes needed to bring each target into alignment with the philosophy.
