...
internal sealed class DspConfig
{
    ...
    [JsonPropertyName("plugins")] public Dictionary<string, DspPluginMetadata> Plugins { get; set; } = new();
}

internal sealed record DspPluginMetadata(
    [property: JsonPropertyName("path")] string Path,
    [property: JsonPropertyName("name")] string? PluginName,
    [property: JsonPropertyName("rawParameters")]
    string RawParameters,
    [property: JsonPropertyName("parameters")]
    IReadOnlyList<DspPluginParameter>? Parameters,
    [property: JsonPropertyName("scannedAtUtc")]
    DateTimeOffset ScannedAtUtc,
    [property: JsonPropertyName("pluginModifiedUtc")]
    DateTimeOffset PluginModifiedUtc
);
...
internal sealed record DspPluginParameter(
    ...
    string? Default,
    [property: JsonPropertyName("supportsText")]
    bool? SupportsTextValues
);