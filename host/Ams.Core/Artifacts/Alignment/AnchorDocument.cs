...
public sealed record AnchorDocument(
    [property: JsonPropertyName("sectionDetected")] bool SectionDetected,
    [property: JsonPropertyName("section")] AnchorDocumentSection? Section,
    ...
    [property: JsonPropertyName("anchors")] IReadOnlyList<AnchorDocumentAnchor> Anchors,
    [property: JsonPropertyName("windows")] IReadOnlyList<AnchorDocumentWindowSegment>? Windows);
...
public sealed record AnchorDocumentPolicy(
    ...
    [property: JsonPropertyName("targetPerTokens")] int TargetPerTokens,
    [property: JsonPropertyName("minSeparation")] int MinSeparation,
    [property: JsonPropertyName("disallowBoundaryCross")] bool DisallowBoundaryCross,
    [property: JsonPropertyName("stopwords")] string Stopwords);

public sealed record AnchorDocumentTokenStats(
    [property: JsonPropertyName("bookCount")] int BookCount,
    [property: JsonPropertyName("bookFilteredCount")] int BookFilteredCount,
    [property: JsonPropertyName("asrCount")] int AsrCount,
    [property: JsonPropertyName("asrFilteredCount")] int AsrFilteredCount);

public sealed record AnchorDocumentWindow(
    [property: JsonPropertyName("bookStart")] int BookStart,
    [property: JsonPropertyName("bookEnd")] int BookEnd);

public sealed record AnchorDocumentAnchor(
    [property: JsonPropertyName("bp")] int BookPosition,
    [property: JsonPropertyName("bpWordIndex")] int BookWordIndex,
