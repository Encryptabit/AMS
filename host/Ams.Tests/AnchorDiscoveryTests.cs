...
public class SectionLocatorTests
{
    ...
    public void Preprocessor_And_Pipeline_Map_And_Restrict()
    {
        ...
        var bookTokens = new List<string>
            { "a", "b", "c", "d", "e", "f", "g", "h", "i", "j", "k", "l", "black", "forest", "m", "n", "o" };
        var words = new List<BookWord>();
        ...
        var asr = new AsrResponse("model",
            new[] { new AsrToken(0, 1, "x"), new AsrToken(1, 1, "black"), new AsrToken(2, 1, "forest") });
