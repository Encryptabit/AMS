...
**Location**: [`/Ams.Web.sln`](/Ams.Web.sln)

**Purpose**: The **full solution file** for Visual Studio that includes ALL projects in the workspace.

**Contains**:
- Server projects (`Ams.Web.Server.Web`, `Ams.Web.Server.Api`, `Ams.Web.Server.Shared`, `Ams.Web.Server.AppHost`)
- Client projects (`Ams.Web.Client.Core`, `Ams.Web.Client.Web`, `Ams.Web.Client.Maui`, `Ams.Web.Client.Windows`)
- Shared project (`Ams.Web.Shared`)
- Tests project (`Ams.Web.Tests`)
...
### 2.2 `Ams.Web.Web.slnf`

**Location**: [`/Ams.Web.Web.slnf`](/Ams.Web.Web.slnf)
...
- `Ams.Web.Server.Web`
- `Ams.Web.Server.Api`
- `Ams.Web.Server.Shared`
- `Ams.Web.Server.AppHost`
- `Ams.Web.Client.Core`
- `Ams.Web.Client.Web`
- `Ams.Web.Shared`
- `Ams.Web.Tests`
...
**Location**: [`/Ams.Web.slnx`](/Ams.Web.slnx)
...
<Using Include="Ams.Web.Shared.Dtos" />
<Using Include="Ams.Web.Shared.Exceptions" />
<!-- ... and many more -->
```
...
```json
{
    ...
    "dotnet.defaultSolution": "Ams.Web.Web.slnf",
...
- **Default Solution**: Uses `Ams.Web.Web.slnf` for faster load times
...
- **`build`**: Builds the `Ams.Web.Server.Web` project
...
```json
{
    "configurations": [
        {
            "name": "C#: Ams.Web.Server.Web Debug",
            "type": "dotnet",
            "request": "launch",
            "projectPath": "${workspaceFolder}/src/Server/Ams.Web.Server.Web/Ams.Web.Server.Web.csproj"
        },
        {
            "name": "C#: Ams.Web.Server.Api Debug",
            "type": "dotnet",
            "request": "launch",
            "projectPath": "${workspaceFolder}/src/Server/Ams.Web.Server.Api/Ams.Web.Server.Api.csproj"
        },
        {
            "name": ".NET MAUI",
            "type": "maui",
...
- **Custom Ams.Web patterns**:
  - `*Resource.designer.cs` (auto-generated from `.resx`)
  - `/src/Client/Ams.Web.Client.Core/Scripts/*.js` (generated from TypeScript)
  - `/src/Client/Ams.Web.Client.Maui/Platforms/Android/google-services.json` (sensitive Firebase config)
