...
**File**: [`src/Server/Ams.Web.Server.Api/Controllers/AppControllerBase.cs`](/src/Server/Ams.Web.Server.Api/Controllers/AppControllerBase.cs)
...
3. **Cleaner Code**: Less ams.web, more focus on business logic.

### Example from CategoryController

**File**: [`src/Server/Ams.Web.Server.Api/Controllers/Categories/CategoryController.cs`](/src/Server/Ams.Web.Server.Api/Controllers/Categories/CategoryController.cs)
...
**File**: [`src/Client/Ams.Web.Client.Core/Services/ODataQuery.cs`](/src/Client/Ams.Web.Client.Core/Services/ODataQuery.cs)
...
**File**: [`src/Client/Ams.Web.Client.Core/Components/Pages/Products/ProductsPage.razor.cs`](/src/Client/Ams.Web.Client.Core/Components/Pages/Products/ProductsPage.razor.cs)
...
2. Implement the interface in `Ams.Web.Server.Api/Controllers` (server-side)
