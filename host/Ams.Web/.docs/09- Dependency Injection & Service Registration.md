...
This stage explains how Dependency Injection (DI) is structured in the Ams.Web project and where services are registered for different platforms and environments.
...
2. **`IClientCoreServiceCollectionExtensions.cs`** ([`src/Client/Ams.Web.Client.Core/Extensions/`](/src/Client/Ams.Web.Client.Core/Extensions/IClientCoreServiceCollectionExtensions.cs))
...
3. **`Program.Services.cs`** files in each project
   ...
   | File | Purpose |
   |------|---------|
   | [`Ams.Web.Server.Api/Program.Services.cs`](/src/Server/Ams.Web.Server.Api/Program.Services.cs) | API server services (DbContext, Identity, Email, SMS, Push Notifications, AI, Hangfire) |
   | [`Ams.Web.Server.Web/Program.Services.cs`](/src/Server/Ams.Web.Server.Web/Program.Services.cs) | Blazor Server/SSR services (combines API + Client services) |
   | [`Ams.Web.Client.Web/Program.Services.cs`](/src/Client/Ams.Web.Client.Web/Program.Services.cs) | Blazor WebAssembly-specific services |
   | [`Ams.Web.Client.Maui/MauiProgram.Services.cs`](/src/Client/Ams.Web.Client.Maui/MauiProgram.Services.cs) | MAUI services (Android, iOS, macOS, Windows via MAUI) |
   | [`Ams.Web.Client.Windows/Program.Services.cs`](/src/Client/Ams.Web.Client.Windows/Program.Services.cs) | Windows Forms Blazor Hybrid services |
...
4. **Platform-specific extensions** (MAUI only)
   ...
   |---------------|----------|
   | [`IAndroidServiceCollectionExtensions.cs`](/src/Client/Ams.Web.Client.Maui/Platforms/Android/Extensions/IAndroidServiceCollectionExtensions.cs) | Android-specific services (e.g., `AndroidPushNotificationService`) |
   | [`IIosServiceCollectionExtensions.cs`](/src/Client/Ams.Web.Client.Maui/Platforms/iOS/Extensions/IIosServiceCollectionExtensions.cs) | iOS-specific services |
   | [`IMacServiceCollectionExtensions.cs`](/src/Client/Ams.Web.Client.Maui/Platforms/MacCatalyst/Extensions/IMacServiceCollectionExtensions.cs) | macOS-specific services |
   | [`IWindowsServiceCollectionExtensions.cs`](/src/Client/Ams.Web.Client.Maui/Platforms/Windows/Extensions/IWindowsServiceCollectionExtensions.cs) | Windows (MAUI)-specific services |
...
Located in [`IClientCoreServiceCollectionExtensions.cs`](/src/Client/Ams.Web.Client.Core/Extensions/IClientCoreServiceCollectionExtensions.cs):
...
1. **Define the interface** in `Ams.Web.Shared` or `Ams.Web.Client.Core`
...
```csharp
// src/Client/Ams.Web.Client.Core/Services/ProductSyncService.cs
...
```csharp
// src/Client/Ams.Web.Client.Core/Extensions/IClientCoreServiceCollectionExtensions.cs
