...
The project supports multiple embedding model providers. You configure them in `appsettings.json` under the `AI` section in the `Ams.Web.Server.Api` project.

### 3.1 LocalTextEmbeddingGenerationService (Default)

**Location**: [`src/Server/Ams.Web.Server.Api/Program.Services.cs`](/src/Server/Ams.Web.Server.Api/Program.Services.cs) (lines 367-372)
...
#### **OpenAI Embeddings**
**Configuration** in [`appsettings.json`](/src/Server/Ams.Web.Server.Api/appsettings.json):
```json
"OpenAI": {
...
**File Location**: [`src/Server/Ams.Web.Server.Api/Data/AppDbContext.cs`](/src/Server/Ams.Web.Server.Api/Data/AppDbContext.cs)
...
**File**: [`src/Server/Ams.Web.Server.Api/Models/Products/Product.cs`](/src/Server/Ams.Web.Server.Api/Models/Products/Product.cs)
...
**File**: [`src/Server/Ams.Web.Server.Api/Data/Configurations/Product/ProductConfiguration.cs`](/src/Server/Ams.Web.Server.Api/Data/Configurations/Product/ProductConfiguration.cs)
...
**File**: [`src/Server/Ams.Web.Server.Api/Services/ProductEmbeddingService.cs`](/src/Server/Ams.Web.Server.Api/Services/ProductEmbeddingService.cs)
...
**File**: [`src/Server/Ams.Web.Server.Api/Controllers/Products/ProductController.cs`](/src/Server/Ams.Web.Server.Api/Controllers/Products/ProductController.cs)
