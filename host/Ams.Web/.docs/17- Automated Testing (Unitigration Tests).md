...
The test project is located at [`src/Tests/Ams.Web.Tests.csproj`](/src/Tests/Ams.Web.Tests.csproj) and contains:
...
<RunSettings>
    ...
    <RunConfiguration>
        <EnvironmentVariables>
            ...
            <ConnectionStrings__sqlite>Data Source=Ams.WebDb.db;Mode=Memory;Cache=Shared;</ConnectionStrings__sqlite>
        </EnvironmentVariables>
    </RunConfiguration>
</RunSettings>
```
...
```powershell
# Run all tests
dotnet test src/Tests/Ams.Web.Tests.csproj

# Run specific test
dotnet test src/Tests/Ams.Web.Tests.csproj --filter "FullyQualifiedName~SignInTest"

# Run with verbose output
dotnet test src/Tests/Ams.Web.Tests.csproj --logger "console;verbosity=detailed"
```
...
```yaml
- name: Run Tests
  run: dotnet test src/Tests/Ams.Web.Tests.csproj --configuration Release
