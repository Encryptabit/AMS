...
✓ Builds entire solution (Ams.Web.slnx)
...
2. **Build & Package with Velopack**
   ...
   dotnet vpk pack \
     ...
     -e Ams.Web.Client.Windows.exe \  # Main executable
     -r win-x86 \                   # Runtime
...
1. **Setup Android Signing**
   ...
   - Save as Ams.Web.keystore in project directory
...
2. **Build Android App Bundle (AAB)**
   ...
   dotnet publish -c Release \
     ...
     -p:AndroidSigningKeyStore="Ams.Web.keystore" \
     -p:AndroidSigningKeyAlias=Ams.Web \
