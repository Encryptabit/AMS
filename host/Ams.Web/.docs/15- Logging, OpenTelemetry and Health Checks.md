...
Welcome to Stage 15! In this stage, you'll learn about the comprehensive logging, observability, and health monitoring infrastructure built into the Ams.Web project.
...
This is implemented in [`src/Server/Ams.Web.Server.Api/SignalR/AppHub.cs`](/src/Server/Ams.Web.Server.Api/SignalR/AppHub.cs):
...
From [`src/Server/Ams.Web.Server.Shared/Extensions/WebApplicationBuilderExtensions.cs`](/src/Server/Ams.Web.Server.Shared/Extensions/WebApplicationBuilderExtensions.cs):
...
When running the project with .NET Aspire (via `Ams.Web.Server.AppHost`), the dashboard is automatically available at:

```
https://localhost:2078
```
...
From [`src/Server/Ams.Web.Server.Shared/Extensions/WebApplicationExtensions.cs`](/src/Server/Ams.Web.Server.Shared/Extensions/WebApplicationExtensions.cs):
...
The project includes a custom health check for storage in [`src/Server/Ams.Web.Server.Api/Services/AppStorageHealthCheck.cs`](/src/Server/Ams.Web.Server.Api/Services/AppStorageHealthCheck.cs):
