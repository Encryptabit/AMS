...
**Location**: [`/src/Client/Ams.Web.Client.Core/Components/Pages/Products/ProductsPage.razor`](/src/Client/Ams.Web.Client.Core/Components/Pages/Products/ProductsPage.razor)
...
**Location**: [`/src/Client/Ams.Web.Client.Core/Components/Pages/Products/ProductsPage.razor.cs`](/src/Client/Ams.Web.Client.Core/Components/Pages/Products/ProductsPage.razor.cs)

This file contains the **component logic** - all C# code for the component:

```csharp
using Ams.Web.Shared.Dtos.Products;
using Ams.Web.Shared.Controllers.Products;

namespace Ams.Web.Client.Core.Components.Pages.Products;
...
**Location**: [`/src/Client/Ams.Web.Client.Core/Components/Pages/Products/ProductsPage.razor.scss`](/src/Client/Ams.Web.Client.Core/Components/Pages/Products/ProductsPage.razor.scss)
...
#### Adding to NavBar
**Location**: [`/src/Client/Ams.Web.Client.Core/Components/Layout/NavBar.razor`](/src/Client/Ams.Web.Client.Core/Components/Layout/NavBar.razor)
...
**Location**: [`/src/Client/Ams.Web.Client.Core/Components/Layout/MainLayout.razor.items.cs`](/src/Client/Ams.Web.Client.Core/Components/Layout/MainLayout.razor.items.cs)
...
Some pages need access to native platform features (e.g., device info, native APIs). Instead of placing them in `Ams.Web.Client.Core` and using dependency injection or pub-sub patterns, you can create **platform-specific pages** directly in platform projects.

#### Example: AboutPage

The `AboutPage` demonstrates this pattern by existing in multiple platform projects:
- [`/src/Client/Ams.Web.Client.Maui/Components/Pages/AboutPage.razor`](/src/Client/Ams.Web.Client.Maui/Components/Pages/AboutPage.razor)
- [`/src/Client/Ams.Web.Client.Windows/Components/Pages/AboutPage.razor`](/src/Client/Ams.Web.Client.Windows/Components/Pages/AboutPage.razor)
- [`/src/Client/Ams.Web.Client.Web/Components/Pages/AboutPage.razor`](/src/Client/Ams.Web.Client.Web/Components/Pages/AboutPage.razor)
...
**In `Ams.Web.Client.Maui.csproj`, `Ams.Web.Client.Windows.csproj`, and `Ams.Web.Client.Web.csproj`:**
...
<Target Name="BuildCssFiles">
    <Exec Command="../Ams.Web.Client.Core/node_modules/.bin/sass Components:Components" />
</Target>
```
...
**Location**: [`/src/Client/Ams.Web.Client.Core/Styles/app.scss`](/src/Client/Ams.Web.Client.Core/Styles/app.scss)
...
**Location**: [`/src/Client/Ams.Web.Client.Core/Styles/abstracts/_bit-css-variables.scss`](/src/Client/Ams.Web.Client.Core/Styles/abstracts/_bit-css-variables.scss)
...
**Location**: [`/src/Client/Ams.Web.Client.Core/Components/Pages/AppPageBase.cs`](/src/Client/Ams.Web.Client.Core/Components/Pages/AppPageBase.cs)
