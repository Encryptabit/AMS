...
Welcome to Stage 6! In this stage, you will learn about the comprehensive exception handling and error management system built into the Ams.Web project.
...
From [`src/Server/Ams.Web.Server.Api/Controllers/Identity/IdentityController.EmailConfirmation.cs`](/src/Server/Ams.Web.Server.Api/Controllers/Identity/IdentityController.EmailConfirmation.cs):
...
**Location:** [`src/Server/Ams.Web.Server.Api/Extensions/KnownExceptionExtensions.cs`](/src/Server/Ams.Web.Server.Api/Extensions/KnownExceptionExtensions.cs)
...
```json
{
  "type": "Ams.Web.Shared.Exceptions.TooManyRequestsException",
...
From [`src/Server/Ams.Web.Server.Api/Controllers/Identity/IdentityController.cs`](/src/Server/Ams.Web.Server.Api/Controllers/Identity/IdentityController.cs):
...
From [`src/Client/Ams.Web.Client.Core/Components/Pages/Identity/SignIn/SignInPanel.razor.cs`](/src/Client/Ams.Web.Client.Core/Components/Pages/Identity/SignIn/SignInPanel.razor.cs):
...
**Location:** [`src/Client/Ams.Web.Client.Core/Components/AppComponentBase.cs`](/src/Client/Ams.Web.Client.Core/Components/AppComponentBase.cs)
...
From [`src/Client/Ams.Web.Client.Core/Components/Pages/Identity/SignIn/SignInPanel.razor`](/src/Client/Ams.Web.Client.Core/Components/Pages/Identity/SignIn/SignInPanel.razor):
...
**Handled by:** `BitMessageBoxService` in [`ClientExceptionHandlerBase`](/src/Client/Ams.Web.Client.Core/Services/ClientExceptionHandlerBase.cs)
...
**Handled by:** `SnackBarService` in [`ClientExceptionHandlerBase`](/src/Client/Ams.Web.Client.Core/Services/ClientExceptionHandlerBase.cs)
...
**Location:** [`src/Client/Ams.Web.Client.Core/Components/AppErrorBoundary.razor`](/src/Client/Ams.Web.Client.Core/Components/AppErrorBoundary.razor)
...
**Location:** [`src/Server/Ams.Web.Server.Api/Services/ServerExceptionHandler.cs`](/src/Server/Ams.Web.Server.Api/Services/ServerExceptionHandler.cs)
...
```json
{
  "type": "Ams.Web.Shared.Exceptions.ResourceNotFoundException",
...
**Location:** [`src/Client/Ams.Web.Client.Core/Services/ClientExceptionHandlerBase.cs`](/src/Client/Ams.Web.Client.Core/Services/ClientExceptionHandlerBase.cs)
...
**Location:** [`src/Client/Ams.Web.Client.Web/Services/WebClientExceptionHandler.cs`](/src/Client/Ams.Web.Client.Web/Services/WebClientExceptionHandler.cs)
...
**Location:** [`src/Client/Ams.Web.Client.Maui/Services/MauiExceptionHandler.cs`](/src/Client/Ams.Web.Client.Maui/Services/MauiExceptionHandler.cs)
...
**Location:** [`src/Client/Ams.Web.Client.Windows/Services/WindowsExceptionHandler.cs`](/src/Client/Ams.Web.Client.Windows/Services/WindowsExceptionHandler.cs)
