...
### Location
[`/src/Client/Ams.Web.Client.Core/tsconfig.json`](/src/Client/Ams.Web.Client.Core/tsconfig.json)
...
### Location
[`/src/Client/Ams.Web.Client.Core/package.json`](/src/Client/Ams.Web.Client.Core/package.json)
...
### Location
[`/src/Client/Ams.Web.Client.Core/Ams.Web.Client.Core.csproj`](/src/Client/Ams.Web.Client.Core/Ams.Web.Client.Core.csproj)
...
**Location:** [`/src/Client/Ams.Web.Client.Core/Scripts/App.ts`](/src/Client/Ams.Web.Client.Core/Scripts/App.ts)
...
**Location:** [`/src/Client/Ams.Web.Client.Core/Extensions/IJSRuntimeExtensions.cs`](/src/Client/Ams.Web.Client.Core/Extensions/IJSRuntimeExtensions.cs)
...
Run the following commands in the `Ams.Web.Client.Core` directory:

```powershell
cd src/Client/Ams.Web.Client.Core
npm install uuid
...
Add this import at the top and new method to the `App` class in [`Scripts/App.ts`](/src/Client/Ams.Web.Client.Core/Scripts/App.ts):
...
Add this method to [`Extensions/IJSRuntimeExtensions.cs`](/src/Client/Ams.Web.Client.Core/Extensions/IJSRuntimeExtensions.cs):
...
```powershell
cd src/Server/Ams.Web.Server.Web
dotnet build
```
