...
Welcome to **Stage 13** of the Ams.Web project getting started guide! In this stage, we'll explore the **Force Update System** - a critical feature that ensures all users are running compatible versions of your application.
...
**File**: [`src/Client/Ams.Web.Client.Core/Services/HttpMessageHandlers/RequestHeadersDelegatingHandler.cs`](/src/Client/Ams.Web.Client.Core/Services/HttpMessageHandlers/RequestHeadersDelegatingHandler.cs)
...
**File**: [`src/Client/Ams.Web.Client.Core/Extensions/IClientCoreServiceCollectionExtensions.cs`](/src/Client/Ams.Web.Client.Core/Extensions/IClientCoreServiceCollectionExtensions.cs)
...
**File**: [`src/Server/Ams.Web.Server.Api/RequestPipeline/ForceUpdateMiddleware.cs`](/src/Server/Ams.Web.Server.Api/RequestPipeline/ForceUpdateMiddleware.cs)
...
**File**: [`src/Server/Ams.Web.Server.Api/appsettings.json`](/src/Server/Ams.Web.Server.Api/appsettings.json)
...
**File**: [`src/Server/Ams.Web.Server.Api/ServerApiSettings.cs`](/src/Server/Ams.Web.Server.Api/ServerApiSettings.cs)
...
**File**: [`src/Client/Ams.Web.Client.Core/Services/HttpMessageHandlers/ExceptionDelegatingHandler.cs`](/src/Client/Ams.Web.Client.Core/Services/HttpMessageHandlers/ExceptionDelegatingHandler.cs)
...
**File**: [`src/Client/Ams.Web.Client.Core/Services/Contracts/IAppUpdateService.cs`](/src/Client/Ams.Web.Client.Core/Services/Contracts/IAppUpdateService.cs)
...
**File**: [`src/Client/Ams.Web.Client.Web/Services/WebAppUpdateService.cs`](/src/Client/Ams.Web.Client.Web/Services/WebAppUpdateService.cs)
...
**File**: [`src/Client/Ams.Web.Client.Windows/Services/WindowsAppUpdateService.cs`](/src/Client/Ams.Web.Client.Windows/Services/WindowsAppUpdateService.cs)
...
**File**: [`src/Client/Ams.Web.Client.Maui/Services/MauiAppUpdateService.cs`](/src/Client/Ams.Web.Client.Maui/Services/MauiAppUpdateService.cs)
...
**File**: [`src/Client/Ams.Web.Client.Core/Components/Layout/ForceUpdateSnackBar.razor`](/src/Client/Ams.Web.Client.Core/Components/Layout/ForceUpdateSnackBar.razor)
...
**File**: [`src/Client/Ams.Web.Client.Core/Components/Layout/ForceUpdateSnackBar.razor.cs`](/src/Client/Ams.Web.Client.Core/Components/Layout/ForceUpdateSnackBar.razor.cs)
