...
Welcome to **Stage 2** of the Ams.Web project tutorial! In this stage, you'll learn about:
...
```csharp
namespace Ams.Web.Shared.Dtos.Categories;
...
**More info**: [Server/Mappers/README.md](/src/Server/Ams.Web.Server.Api/Mappers/Readme.md)
...
**Location**: [`src/Server/Ams.Web.Server.Api/Mappers/CategoriesMapper.cs`](/src/Server/Ams.Web.Server.Api/Mappers/CategoriesMapper.cs)
...
For reference, here's the entity model: [`Category.cs`](/src/Server/Ams.Web.Server.Api/Models/Categories/Category.cs)
...
**Example from [`CategoryController.cs`](/src/Server/Ams.Web.Server.Api/Controllers/Categories/CategoryController.cs):**
...
**Location**: [`AddOrEditCategoryModal.razor.cs`](/src/Client/Ams.Web.Client.Core/Components/Pages/Categories/AddOrEditCategoryModal.razor.cs)
...
**Location**: [`ProfileSection.razor.cs`](/src/Client/Ams.Web.Client.Core/Components/Pages/Settings/ProfileSection.razor.cs)
