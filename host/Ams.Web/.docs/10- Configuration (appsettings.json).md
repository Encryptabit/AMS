...
- [`src/Client/Ams.Web.Client.Core/appsettings.json`](/src/Client/Ams.Web.Client.Core/appsettings.json) - Client-side shared configuration
- [`src/Client/Ams.Web.Client.Core/appsettings.Development.json`](/src/Client/Ams.Web.Client.Core/appsettings.Development.json) - Development overrides
- [`src/Client/Ams.Web.Client.Core/appsettings.Production.json`](/src/Client/Ams.Web.Client.Core/appsettings.Production.json) - Production overrides

### Platform-Specific Configuration
- **Blazor WebAssembly**: [`src/Client/Ams.Web.Client.Web/appsettings.json`](/src/Client/Ams.Web.Client.Web/appsettings.json)
- **.NET MAUI**: [`src/Client/Ams.Web.Client.Maui/appsettings.json`](/src/Client/Ams.Web.Client.Maui/appsettings.json)
- **Windows**: [`src/Client/Ams.Web.Client.Windows/appsettings.json`](/src/Client/Ams.Web.Client.Windows/appsettings.json)

### Server Configuration
- **API Server**: [`src/Server/Ams.Web.Server.Api/appsettings.json`](/src/Server/Ams.Web.Server.Api/appsettings.json)
- **Web Server**: Server.Web uses standard ASP.NET Core configuration hierarchy
- **AppHost**: [`src/Server/Ams.Web.Server.AppHost/appsettings.json`](/src/Server/Ams.Web.Server.AppHost/appsettings.json)

## Configuration Priority Hierarchy

The configuration system loads settings in a specific order, with **later sources overriding earlier ones**. This is defined in [`IConfigurationBuilderExtensions.cs`](/src/Client/Ams.Web.Client.Core/Extensions/IConfigurationBuilderExtensions.cs):
...
In [`src/Client/Ams.Web.Client.Core/appsettings.json`](/src/Client/Ams.Web.Client.Core/appsettings.json), client-specific settings are defined:

```json
{
    "ServerAddress": "http://localhost:5000/",
    "ServerAddress_Comment": "If you're running Ams.Web.Server.Web project, then you can also use relative urls such as / for Blazor Server and WebAssembly",
...
In [`src/Client/Ams.Web.Client.Maui/appsettings.json`](/src/Client/Ams.Web.Client.Maui/appsettings.json):
...
In [`src/Server/Ams.Web.Server.Api/appsettings.json`](/src/Server/Ams.Web.Server.Api/appsettings.json), you'll find comprehensive server settings:

```json
{
    "ConnectionStrings": {
        "mssqldb": "Data Source=(localdb)\\mssqllocaldb; Initial Catalog=Ams.WebDb;...",
...
```json
{
    ...
    "ConnectionStrings": {
        "Aspire__Comment": "Running Ams.Web.Server.AppHost `overrides` the following connection strings at runtime.",
        "mssqldb": "Data Source=(localdb)\\mssqllocaldb; Initial Catalog=Ams.WebDb;...",
...
**From `src/Server/Ams.Web.Server.AppHost/appsettings.Development.json`:**
```json
{
    "Parameters": {
...
**From `src/Client/Ams.Web.Client.Core/appsettings.json`:**
```json
{
    "AdUnitPath__Comment": "The advertisement's unit path of the google ads from the Google Ad Manager panel."
}
...
2. Override in platform-specific files:
   - For MAUI: [`src/Client/Ams.Web.Client.Maui/appsettings.json`](/src/Client/Ams.Web.Client.Maui/appsettings.json)
   - For Web: [`src/Client/Ams.Web.Client.Web/appsettings.json`](/src/Client/Ams.Web.Client.Web/appsettings.json)
   - For Windows: [`src/Client/Ams.Web.Client.Windows/appsettings.json`](/src/Client/Ams.Web.Client.Windows/appsettings.json)
