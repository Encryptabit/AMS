...
Welcome to the interactive Getting Started guide! This document will walk you through the Entity Framework Core architecture in this Ams.Web project.
...
[`/src/Server/Ams.Web.Server.Api/Data/AppDbContext.cs`](/src/Server/Ams.Web.Server.Api/Data/AppDbContext.cs)
...
[`/src/Server/Ams.Web.Server.Api/Models/`](/src/Server/Ams.Web.Server.Api/Models/)
...
**File:** [`/src/Server/Ams.Web.Server.Api/Models/Categories/Category.cs`](/src/Server/Ams.Web.Server.Api/Models/Categories/Category.cs)

```csharp
using Ams.Web.Server.Api.Models.Products;

namespace Ams.Web.Server.Api.Models.Categories;
...
[`/src/Server/Ams.Web.Server.Api/Data/Configurations/`](/src/Server/Ams.Web.Server.Api/Data/Configurations/)
...
**File:** [`/src/Server/Ams.Web.Server.Api/Data/Configurations/Category/CategoryConfiguration.cs`](/src/Server/Ams.Web.Server.Api/Data/Configurations/Category/CategoryConfiguration.cs)

```csharp
using Ams.Web.Server.Api.Models.Categories;

namespace Ams.Web.Server.Api.Data.Configurations.Identity;
...
**File:** [`/src/Server/Ams.Web.Server.Api/Program.cs`](/src/Server/Ams.Web.Server.Api/Program.cs)
```csharp
...
Open a terminal in the `Ams.Web.Server.Api` project directory and run:
