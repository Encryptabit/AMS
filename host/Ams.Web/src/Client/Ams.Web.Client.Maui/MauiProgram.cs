...
using Ams.Web.Client.Core.Styles;
using Ams.Web.Client.Maui.Services;
...
public static partial class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        var builder = MauiApp.CreateBuilder();
            ...
            .UseMauiApp<App>()
            .UseAppStoreInfo()
            .Configuration.AddClientConfigurations(clientEntryAssemblyName: "Ams.Web.Client.Maui");
        ...
        mauiApp.Services.GetRequiredService<PubSubService>()
            .Subscribe(ClientAppMessages.PAGE_DATA_CHANGED, async (args) =>
            {
                ...
                {
                    Application.Current!.Windows.First().Title = title ?? "Ams.Web";
                });
            });
