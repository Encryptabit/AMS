...
using Ams.Web.Server.Api.Models.Emailing;
...
public partial class EmailService
{
    ...
    {
        backgroundJobClient.Enqueue<EmailServiceJobsRunner>(jobRunner => jobRunner.SendEmailJob(toEmailAddress, toName, subject, body, null, CancellationToken.None));
    }
