...
using Ams.Web.Shared;
using Ams.Web.Shared.Attributes;
using Hangfire;
using Scalar.AspNetCore;
using Ams.Web.Server.Api;
using Ams.Web.Server.Api.RequestPipeline;
using Ams.Web.Server.Api.Services;

namespace Ams.Web.Server.Web;
...
public static partial class Program
{
    ...
    public static void ConfigureMiddlewares(this WebApplication app)
    {
        ...
        var blazorApp = app.MapRazorComponents<Components.App>()
            ...
            .AddAdditionalAssemblies(AssemblyLoadContext.Default.Assemblies.Where(asm => asm.GetName().Name?.Contains("Ams.Web.Client") is true).ToArray());
