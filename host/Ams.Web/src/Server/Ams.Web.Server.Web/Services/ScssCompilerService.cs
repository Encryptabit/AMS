...
namespace Ams.Web.Server.Web.Services;
...
public class ScssCompilerService
{
    internal static async Task WatchScssFiles(WebApplication app)
    {
        ...
        var clientCorePath = Path.Combine(Environment.CurrentDirectory, "../../Client/Ams.Web.Client.Core");
        ...
        // but uses ../../Client/Ams.Web.Client.Web:../../Client/Ams.Web.Client.Web instead of .:.,
        ...
        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/Ams.Web.Client.Maui/Components")))
            sassPathsToWatch.Add("../../Client/Ams.Web.Client.Maui/Components:../../Client/Ams.Web.Client.Maui/Components");

        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/Ams.Web.Client.Windows/Components")))
            sassPathsToWatch.Add("../../Client/Ams.Web.Client.Windows/Components:../../Client/Ams.Web.Client.Windows/Components");

        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/Ams.Web.Client.Web/Components")))
            sassPathsToWatch.Add("../../Client/Ams.Web.Client.Web/Components:../../Client/Ams.Web.Client.Web/Components");
